...
import { Upload, FileText, CheckCircle, AlertCircle, Target, TrendingUp, Award, Zap, BarChart3, PieChart } from "lucide-react";
    ...
    try {
      ...
      const mockResult = {
        ...
        strengths: [
          ...
          "Well-structured work experience with quantified achievements",
        ...
        improvements: [
          ...
          "Optimize section headings for ATS scanning",
        ...
        keywordAnalysis: "Good keyword usage with room for improvement",
        formattingScore: 85,
        contentScore: 72
      };
